...
<div class="container-fluid">
    <section>
        ...
        <h1 class="ets">Paqua'Service</h1><br>
        <div class="sectionM">
            <p class="text-justify">
                Agence de proximité à taille humaine, Paqua'Service fidélise ses clients par une personnalisation du service
        ...
        <!--les activités de PaQua'Service-->
        <div class="sectionB">
            <div class="derat">
