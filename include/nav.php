      ...
      <div class="collapse navbar-collapse" id="navbarsExample03">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item" id="tailleLi">
            <a class="nav-link" id="tailleA" href="index.php">Acceuil</a>
          </li>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle navMarg colorJ" href="#" id="dropdown03" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false">Prestations</a>
          ...
          <hr class="mx-auto bg-dark text-center">
          <li class="nav-item">
            <a class="nav-link navMarg colorB" href="nettoyage.php">Tarifs</a>
          </li>
          <hr class="mx-auto bg-dark text-center">
          <li class="nav-item">
            <a class="nav-link navMarg colorV" href="espacevert.php" tabindex="-1" aria-disabled="true">Promo</a>
          </li>
          <hr class="mx-auto bg-dark text-center">
          <li class="nav-item dropdown">
